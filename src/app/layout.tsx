  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Погрузитесь в захватывающие приключения с лучшими перформанс хоррор квестами для всей семьи в Калининграде! Ощутите незабываемые эмоции!" />
        <meta charSet="utf-8" />
        ...
        <meta property="og:description" content="Погрузитесь в захватывающие приключения с лучшими перформанс хоррор квестами для всей семьи в Калининграде! Ощутите незабываемые эмоции!" />
